local bookmarks = {
	...
	parq_passes = 'https://main.d2xuop51ekcwbf.amplifyapp.com',
	parq_payvalida_doc = 'https://docs.payvalida.com/documentacion',
	parq_payvalida_sandbox = 'https://sandbox-merchant.payvalida.com/signin',
