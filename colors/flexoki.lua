---@see https://github.com/cpplain/dotfiles/blob/main/home/.config/nvim/colors/flexoki.lua
...
hl('@markup.strong', { bold = true, fg = c.yellow })
hl('@markup.italic', { italic = true, fg = c.blue })
hl('@markup.strikethrough', { strikethrough = true, fg = c.tx3 })
...
hl('@markup.raw', { bg = '#151618' })
hl('@markup.raw.block', { link = '@markup.raw' })
hl('RenderMarkdownCode', { link = '@markup.raw' })
hl('RenderMarkdownCodeInline', { fg = c.green, bg = c.green4 })
