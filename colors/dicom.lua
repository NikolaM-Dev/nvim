...
-- NKL Extras
h('StatusLine', { bg = colors.bg })
h('StatusLineNC', { bg = colors.bg })
h('Winbar', { bg = colors.bg })
h('WinbarNC', { bg = colors.bg })
h('BlinkCmpGhostText', { fg = colors.fg_dim })
h('DiagnosticVirtualTextError', { fg = colors.red, bg = colors.bg })
h('DiagnosticVirtualTextWarn', { fg = colors.orange, bg = colors.bg })
h('DiagnosticVirtualTextHint', { fg = colors.cyan, bg = colors.bg })
h('DiagnosticVirtualTextInfo', { fg = colors.blue, bg = colors.bg })
h('EyelinerPrimary', { link = 'Substitute' })
h('CleverFDefaultLabel', { link = 'Substitute' })
h('EyelinerSecondary', { link = 'IncSearch' })
h('fFHintChar', { link = 'IncSearch' })
h('fFHintNumber', { link = 'IncSearch' })
h('CheckboxCanceled', { fg = colors.red })
h('NonText', { fg = colors.comment })
h('SnacksNormal', { bg = colors.bg, fg = colors.fg })
h('SnacksPicker', { bg = colors.bg })
h('RenderMarkdownCode', { bg = colors.cursorline_bg })
h('Tag', { fg = colors.cyan, italic = true })
h('ColorColumn', { bg = colors.cursorline_bg })
h('Pmenu', { bg = colors.cursorline_bg })
h('NormalFloat', { bg = colors.cursorline_bg })
h('FloatShadow', { bg = colors.cursorline_bg })
h('FloatShadowThrough', { bg = colors.cursorline_bg })
h('RenderMarkdownCodeInline', { bg = colors.green, fg = colors.bg })
h('RenderMarkdownCodeInline', { fg = colors.green })
h('Error', { bg = colors.bg, fg = colors.red })
h('TreesitterContextLineNumber', { fg = colors.yellow })
h('@markup.italic', { fg = colors.cyan, italic = true })
h('@markup.italic', { fg = colors.cyan, italic = true })
h('@markup.strong', { fg = colors.blue, bold = true })
